...
import { getRejectedOpsApprovalTransactions } from "../../../shared/services/api/payment.api";
...
export function PaymentRejectedPageComponent() {
  ...
  const fetchTransactions = useCallback(async () => {
    ...
    try {
      ...
      const response = await getRejectedOpsApprovalTransactions({
        brandId,
          ...
          <table className="w-full text-sm border-collapse table-fixed">
            <thead className="sticky top-0 z-20 bg-[var(--background)]">
              <tr className="text-[var(--on-surface)]/60 border-b border-[var(--muted)]/15">
                ...
                {/* OPS Approval Status */}
                <th className="px-3 py-3 text-left font-semibold text-xs uppercase tracking-wider w-[110px]">
                  Ops Approval Status
                </th>
              ...
              {!loading &&
                sortedTransactions.map((tx, idx) => (
                  ...
                  >
                    ...
                    <td className="px-3 py-3">
                      <ApprovalStatusBadge status={tx.opsApprovalStatus} />
                    </td>
