...
import { preCollection } from "../../../shared/services/api/collection.api";
...
export function PreCollection() {
  ...
  const isCollectionExecutive =
    isCrmZeptofinanceDomain &&
    auth?.role?.some((r) => r === "COLLECTION_EXECUTIVE");
  ...
  const fetchCollections = useCallback(async () => {
    ...
    try {
      ...
      const response = await preCollection(
        brandId,
        {
  ...
  // Simple render function to display collection data
    ...
    <>
      ...
      <div className="flex flex-col gap-6 p-6">
        ...
        <div className="flex flex-col gap-4">
          <h1 className="text-2xl font-bold">Pre Collections</h1>
          <SearchInput
