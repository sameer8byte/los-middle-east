...
export function AllCollection() {
  ...
  const renderCollectionRow = (item: CollectionLoan) => (
    ...
    >
      ...
      {/* 5. ACTIONS */}
      <td className="px-4 py-4 w-[8%] text-right align-middle">
    ...
    <>
      ...
      {commentModal.isOpen && (
        <RemarksCommentModal
          ...
          loanId={commentModal.loanId!}
          loans={collections.filter((l) => l.id === commentModal.loanId)}
      ...
      <div className="flex flex-col gap-6 p-6">
        ...
        <div className="flex flex-col gap-4">
          <h1 className="text-2xl font-bold">
            All Collections <small>( pre + post )</small>
          </h1>
          <SearchInput
              ...
              <table className="min-w-full divide-y divide-gray-200">
                <thead className="bg-gray-50">
                  <tr>
                    ...
                    <th
                      scope="col"
                      className="px-4 py-3.5 text-right text-xs font-semibold text-gray-500 uppercase tracking-wider w-[8%]"
                    >
                      Actions
                    </th>
                  </tr>
