      ...
      <div className="w-full space-y-6">
          ...
          <div>
            ...
            <select
              ...
              className={`mt-1 block w-full rounded-lg border px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-primary ${
                errors.status ? "border-error" : "border-[var(--color-muted)] border-opacity-50"
              }`}
            >
        ...
        <div className="flex justify-end space-x-3 pt-4">
          <button
            ...
            className="px-4 py-2 text-sm text-[var(--color-on-surface)] opacity-80 hover:bg-[var(--color-background)] rounded-md border border-[var(--color-muted)] border-opacity-50"
            disabled={loading}
          >
            Cancel
          </button>
