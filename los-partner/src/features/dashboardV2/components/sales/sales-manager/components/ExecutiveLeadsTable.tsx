          ...
          <tbody className="divide-y divide-gray-200">
            {loading ? (
              ...
              <tr key={row.id} className="hover:bg-gray-50">
                ...
                <td className="px-4 py-3 text-sm text-gray-900">₹ {(row.amountSanctioned ?? 0).toLocaleString()}</td>
                <td className="px-4 py-3 text-sm text-gray-900">₹ {(row.disbursedAmount ?? 0).toLocaleString()}</td>
                <td className="px-4 py-3 text-sm text-gray-900">₹ {(row.pendingDisbursal ?? 0).toLocaleString()}</td>
                <td className="px-4 py-3 text-sm text-gray-900">₹ {(row.avgLoanAmount ?? 0).toLocaleString()}</td>
