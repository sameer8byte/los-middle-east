...
// import { submitRating, getExecutives } from "../services/dashboardApi";
...
export const AddRatingModal = ({ isOpen, onClose }: AddRatingModalProps) => {
  ...
  return (
    <div 
      ...
      style={{ borderRadius: '16px', zIndex: 10, backdropFilter: 'blur(4px)', backgroundColor: 'rgba(255, 255, 255, 0.1)' }}
