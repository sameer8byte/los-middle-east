...
const CreditPerformance: React.FC = () => {
  ...
  //     try {
  //       setLoading(true);
  //       const response = await getCreditPerformance();
  //       setManagers(response.data);
  //     } catch (error) {
  //       console.error('Error fetching credit performance:', error);
  //     } finally {
  //       setLoading(false);
  //     }
  //   };
  ...
  const managers: ManagerData[] = [
    {
      ...
      teamAvgScore: 7.8,
      executives: [
        { name: 'Alex M', role: 'EXEC', attributes: [8, 7, 9, 8], rank: 3, score: 8.0 },
        { name: 'Sarah K', role: 'EXEC', attributes: [9, 8, 8, 9], rank: 2, score: 8.5 },
      ],
    },
    {
      name: 'Manager D',
