...
const SalesPerformance: React.FC = () => {
  ...
  //     try {
  //       setLoading(true);
  //       const response = await getSalesPerformance();
  ...
  const managers: ManagerData[] = [
    {
      ...
      teamAvgScore: 7.5,
      executives: [
        { name: 'Sofia T', role: 'EXEC', attributes: [8, 8, 8, 8], rank: 8, score: 7.5 },
        { name: 'Liam K', role: 'EXEC', attributes: [7, 7, 7, 7], rank: 9, score: 7.0 },
        { name: 'Amara J', role: 'EXEC', attributes: [9, 9, 9, 9], rank: 6, score: 8.5 },
        { name: 'Ethan R', role: 'EXEC', attributes: [6, 6, 6, 6], rank: 12, score: 6.0 },
        { name: 'Nina F', role: 'EXEC', attributes: [10, 10, 10, 10], rank: 1, score: 9.8 },
        { name: 'Oliver H', role: 'EXEC', attributes: [5, 5, 5, 5], rank: 15, score: 5.0 },
        { name: 'Isabella G', role: 'EXEC', attributes: [8, 8, 8, 8], rank: 7, score: 7.5 },
        { name: 'Lucas P', role: 'EXEC', attributes: [6, 6, 6, 6], rank: 13, score: 6.1 },
        { name: 'Maya S', role: 'EXEC', attributes: [9, 9, 9, 9], rank: 5, score: 8.7 },
        { name: 'Jack D', role: 'EXEC', attributes: [7, 7, 7, 7], rank: 11, score: 6.8 },
      ],
    },
    {
      name: 'Manager B',
