                                ...
                                <tbody className="divide-y divide-gray-100">
                                    {data.executives.map((exec, idx) => (
                                        <tr key={exec.id} className="hover:bg-gray-50/50 transition-colors">
                                            ...
                                            <td className="px-2 py-2 2xl:px-4 2xl:py-4 text-gray-800 font-medium text-center">{exec.sanctionedAmount}</td>
                                            <td className="px-2 py-2 2xl:px-4 2xl:py-4 text-gray-800 font-medium text-center">{exec.disbursedAmount}</td>
                                            <td className="px-2 py-2 2xl:px-4 2xl:py-4 text-gray-800 font-medium text-center">{exec.pendingDisbursalAmt}</td>
