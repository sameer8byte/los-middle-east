...
const MOCK_DATA: ManagerConversion[] = [
    {
        ...
        targetPercent: 90, achievedPercent: 95, gap: 5, avgLoan: 45000
    },
    {
        id: '2', initials: 'MR', name: 'Manager B', rank: 2,
        conversionCurrent: 610, conversionTotal: 900, percentage: 80,
        freshCount: 180, freshPercent: 20, repeatCount: 120, repeatPercent: 22,
        targetPercent: 90, achievedPercent: 80, gap: 10, avgLoan: 42000
    },
    {
        id: '3', initials: 'MR', name: 'Manager C', rank: 3,
        conversionCurrent: 546, conversionTotal: 750, percentage: 55,
        freshCount: 150, freshPercent: 18, repeatCount: 100, repeatPercent: 20,
        targetPercent: 90, achievedPercent: 55, gap: 35, avgLoan: 38000
    },
    {
        id: '4', initials: 'MR', name: 'Manager D', rank: 4,
        conversionCurrent: 400, conversionTotal: 600, percentage: 45,
        freshCount: 120, freshPercent: 15, repeatCount: 80, repeatPercent: 18,
        targetPercent: 90, achievedPercent: 45, gap: 45, avgLoan: 35000
    },
    {
        id: '5', initials: 'MR', name: 'Manager E', rank: 5,
        conversionCurrent: 350, conversionTotal: 550, percentage: 42,
        freshCount: 100, freshPercent: 12, repeatCount: 70, repeatPercent: 15,
        targetPercent: 90, achievedPercent: 42, gap: 48, avgLoan: 32000
    },
    {
        id: '6', initials: 'MR', name: 'Manager F', rank: 6,
        conversionCurrent: 300, conversionTotal: 500, percentage: 40,
        freshCount: 80, freshPercent: 10, repeatCount: 60, repeatPercent: 12,
        targetPercent: 90, achievedPercent: 40, gap: 50, avgLoan: 30000
    },

];

const ConversionContribution: React.FC<ConversionProps> = ({ data = MOCK_DATA }) => {
    ...
    return (
        <div className="bg-white rounded-xl overflow-hidden border border-gray-100 shadow-sm w-full font-sans">
            ...
            <div className="p-3 2xl:p-6">
                ...
                <div className="space-y-3 2xl:space-y-4 max-h-[280px] 2xl:max-h-[365px] overflow-y-auto pr-1 2xl:pr-2 conversion-scrollbar">
                    {data.map((item) => {
                        ...
                        return (
                            ...
                            >
                                <div
                                    className="px-3 py-2.5 2xl:px-5 2xl:py-4 flex flex-col md:flex-row md:items-center gap-2 2xl:gap-4 md:gap-4 cursor-pointer hover:bg-gray-50/50"
                                ...
                                >
                                    ...
                                    <div className="flex items-center md:justify-center w-full md:w-1/3 text-[12px] 2xl:text-[14px] text-gray-600 font-medium tracking-tight">
                                        Conversion : <span className="text-gray-900 font-bold ml-1">{item.conversionCurrent} / {item.conversionTotal}</span>
                                    </div>

                                    <div className="flex items-center justify-between md:justify-end gap-2 2xl:gap-4 w-full md:w-1/3 mt-1 2xl:mt-0">
                                        <div className={`px-3 py-0.5 2xl:px-4 2xl:py-1 rounded-full text-white text-[11px] 2xl:text-[13px] font-bold tracking-wide ${getPillColor(item.percentage)}`}>
                                            {item.percentage}%
                                        </div>
                                        <ChevronDown className={`text-gray-900 transition-transform duration-200 w-4 h-4 2xl:w-5 2xl:h-5 ${isExpanded ? 'rotate-180' : ''}`} />
                                    </div>
                                </div>

                                {isExpanded && (
                                    <div className="px-3 pb-3 pt-0 2xl:px-5 2xl:pb-5 2xl:pt-1">
                                        <div className="border-t border-dashed border-gray-200 pt-3 2xl:pt-5 mt-1">
