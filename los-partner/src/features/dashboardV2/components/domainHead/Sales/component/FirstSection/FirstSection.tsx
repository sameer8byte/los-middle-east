...
export default function FirstSection({ data }: { data?: AUMData }) {
    ...
    const currentData = data ?? {
        totalLoansDueAmount: 92000000,
        totalAmountCollected: 15000000,
        totalAmountOutstanding: "84%",
        postDueAmount: 12000000,
        totalLoansIssued: 210,
        ongoingLoans: 170,
        closedLoans: 40,
        overdueLoans: 60,
    };
    ...
    return (
        <div className="bg-white rounded-xl overflow-hidden border border-gray-100 shadow-sm mt-2 2xl:mt-4 w-full">
            ...
            <div className="bg-gray-100/70 px-4 2xl:px-6 py-2 2xl:py-3 border-b border-gray-100">
                <h2 className="text-[11px] 2xl:text-[13px] font-bold text-gray-800 tracking-wide uppercase">Lead Funnel Overview</h2>
            </div>
