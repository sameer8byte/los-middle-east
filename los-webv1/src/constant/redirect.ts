...
export const ApplicationPageId: Record<ApplicationPage, number> = Object.keys(ApplicationPage)
...
export const PageRouteMap: Record<ApplicationPage, string> = {
  ...
  [ApplicationPage.LoanApplicationPersonalInfo]: "/loan-application/personal-info",
  [ApplicationPage.LoanApplicationBankDetails]: "/loan-application/bank-details",
  [ApplicationPage.LoanApplicationEmploymentInfo]: "/loan-application/employment-info",
  [ApplicationPage.LoanApplicationSelfie]: "/loan-application/selfie",
  [ApplicationPage.LoanApplicationAddressVerification]: "/loan-application/address-verification",
