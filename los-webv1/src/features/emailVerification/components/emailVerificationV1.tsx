      ...
      {step === 1 ? (
        <div className="space-y-4">
          <div className="">
            <label
              htmlFor="email"
              className="block text-sm font-medium text-on-surface mt-4"
            >
              Email Address
            </label>
            <div className="flex items-center">
              <input
                ...
                className={`flex-1 h-12 px-4 py-3 border rounded-brand focus:ring-2 focus:ring-primary-focus focus:border-primary placeholder-on-surface-muted text-on-surface transition-all duration-200 ${
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-2 bg-surface text-on-surface-muted">
                or continue with
              </span>
            </div>
          </div>
